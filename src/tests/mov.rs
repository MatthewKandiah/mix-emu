...
fn should_move_words() {
    ...
    computer.registers.i1 = Index::from_i32(999).unwrap();
    ...
    assert_eq!(computer.registers.i1.to_i32(), 1002);
}

#[test]
fn overlapping_region_edge_case() {
    let mut computer = setup_computer();
    computer.registers.i1 = Index::from_i32(1001).unwrap();
    ...
    assert_eq!(computer.registers.i1.to_i32(), 1004);
}
