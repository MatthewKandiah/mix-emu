mod sta_tests {
    ...
    fn should_store_contents_in_memory() {
        ...
        assert_eq!(computer.memory.get(2000).unwrap(), Word::from_byte_values(Sign::PLUS, 6, 7, 8, 9, 0).unwrap());
    }
    ...
    fn should_store_contents_without_changing_sign() {
        ...
        assert_eq!(computer.memory.get(2000).unwrap(), Word::from_byte_values(Sign::MINUS, 6, 7, 8, 9, 0).unwrap());
    }
    ...
    fn should_store_contents_in_index_adjusted_address() {
        ...
        assert_eq!(computer.memory.get(2000).unwrap(), Word::from_byte_values(Sign::MINUS, 1, 9, 0, 4, 5).unwrap());
    }
    ...
    fn should_store_part_of_contents_in_memory() {
        ...
        assert_eq!(computer.memory.get(2000).unwrap(), Word::from_byte_values(Sign::MINUS, 1, 2, 3, 4, 0).unwrap());
    }
}
